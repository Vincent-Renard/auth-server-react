...
public class UserController {
	...
	public ResponseEntity<Void> resetUpdatePassword(@RequestParam("key") String key, @RequestBody UpdatePasswordRequest upr) throws UserBanException, BadPasswordFormatException, TokenNotFoundException {
